module Story_variables
    ...
    D_t_whitewalker2_encounter_script = """\n
    That was scary!!
    ...
    D_t_storyline_post_whitewalker2_script1 = """\n
    ...
    Bang!!
    You've run straight into a wall
    """

    Corridor_escape_enemy_script = """\n
    You run down the dimly lit corridor...
